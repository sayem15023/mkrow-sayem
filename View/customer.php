...
<div class="content-wrapper">
    ...
    <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title" >গ্রাহকদের তালিকা </h3>
                <a href="#add"><span style="float:right; cursor:pointer;">নতুন গ্রাহক </span></a>
              </div>
              <!-- /.card-header -->
...
$sql = "SELECT id,name,mobileno,address,reference FROM customer where userid=$userid order by name";
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">গ্রাহক যুক্ত করুন</h3>
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="category">গ্রাহকের নাম</label>
